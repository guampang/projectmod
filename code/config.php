...
$CFG->dbname    = 'mod_db';     // database name, eg moodle
$CFG->dbuser    = 'mod_user';   // your database username
$CFG->dbpass    = 'sukses123';   // your database password
...
$CFG->wwwroot   = 'http://blog.jagoanhosting.my.id';
